...
def get_base_manifest() -> Dict[str, Any]:
    ...
    return {
        ...
        "version": "3.0.0",
            ...
            {"type": "series", "id": "adkami_genre_action", "name": "⚔️ Action", "extra": []},
            {"type": "series", "id": "adkami_genre_amitie", "name": "🤝 Amitié", "extra": []},
            {"type": "series", "id": "adkami_genre_aventure", "name": "🗺️ Aventure", "extra": []},
            {"type": "series", "id": "adkami_genre_combat", "name": "🥊 Combat", "extra": []},
            {"type": "series", "id": "adkami_genre_comedie", "name": "😂 Comédie", "extra": []},
            {"type": "series", "id": "adkami_genre_contes_et_recits", "name": "📖 Contes et Récits", "extra": []},
            {"type": "series", "id": "adkami_genre_cyber_et_mecha", "name": "🤖 Cyber et Mecha", "extra": []},
            {"type": "series", "id": "adkami_genre_dark_fantasy", "name": "🌑 Dark Fantasy", "extra": []},
            {"type": "series", "id": "adkami_genre_drame", "name": "🎭 Drame", "extra": []},
            {"type": "series", "id": "adkami_genre_ecchi", "name": "🔥 Ecchi", "extra": []},
            {"type": "series", "id": "adkami_genre_educatif", "name": "📚 Educatif", "extra": []},
            {"type": "series", "id": "adkami_genre_enigme_et_policier", "name": "🔍 Enigme et Policier", "extra": []},
            {"type": "series", "id": "adkami_genre_epique_et_heroique", "name": "🦸 Épique et Héroïque", "extra": []},
            {"type": "series", "id": "adkami_genre_espace_et_sci_fiction", "name": "🚀 Espace et Sci-Fiction", "extra": []},
            {"type": "series", "id": "adkami_genre_familial_et_jeunesse", "name": "👨‍👩‍👧 Familial et Jeunesse", "extra": []},
            {"type": "series", "id": "adkami_genre_fantastique_et_mythe", "name": "🧙 Fantastique et Mythe", "extra": []},
            {"type": "series", "id": "adkami_genre_fantasy", "name": "✨ Fantasy", "extra": []},
            {"type": "series", "id": "adkami_genre_gastronomie", "name": "🍜 Gastronomie", "extra": []},
            {"type": "series", "id": "adkami_genre_gender_bender", "name": "🔄 Gender Bender", "extra": []},
            {"type": "series", "id": "adkami_genre_gyaru", "name": "💅 Gyaru", "extra": []},
            {"type": "series", "id": "adkami_genre_harem", "name": "💕 Harem", "extra": []},
            {"type": "series", "id": "adkami_genre_historique", "name": "⛩️ Historique", "extra": []},
            {"type": "series", "id": "adkami_genre_horreur", "name": "😱 Horreur", "extra": []},
            {"type": "series", "id": "adkami_genre_idols", "name": "🎤 Idols", "extra": []},
            {"type": "series", "id": "adkami_genre_inceste", "name": "⚠️ Inceste", "extra": []},
            {"type": "series", "id": "adkami_genre_isekai", "name": "🌀 Isekai", "extra": []},
            {"type": "series", "id": "adkami_genre_magical_girl", "name": "🪄 Magical Girl", "extra": []},
            {"type": "series", "id": "adkami_genre_magie", "name": "🎩 Magie", "extra": []},
            {"type": "series", "id": "adkami_genre_mature", "name": "🔞 Mature", "extra": []},
            {"type": "series", "id": "adkami_genre_moe", "name": "🥰 Moe", "extra": []},
            {"type": "series", "id": "adkami_genre_monster_girl", "name": "👾 Monster Girl", "extra": []},
            {"type": "series", "id": "adkami_genre_musical", "name": "🎵 Musical", "extra": []},
            {"type": "series", "id": "adkami_genre_mystere", "name": "❓ Mystère", "extra": []},
            {"type": "series", "id": "adkami_genre_psychologique", "name": "🧠 Psychologique", "extra": []},
            {"type": "series", "id": "adkami_genre_romance", "name": "💗 Romance", "extra": []},
            {"type": "series", "id": "adkami_genre_school_life", "name": "🏫 School Life", "extra": []},
            {"type": "series", "id": "adkami_genre_sport", "name": "⚽ Sport", "extra": []},
            {"type": "series", "id": "adkami_genre_surnaturel", "name": "👻 Surnaturel", "extra": []},
            {"type": "series", "id": "adkami_genre_survival_game", "name": "🎯 Survival Game", "extra": []},
            {"type": "series", "id": "adkami_genre_thriller", "name": "😰 Thriller", "extra": []},
            {"type": "series", "id": "adkami_genre_tokusatsu", "name": "🦹 Tokusatsu", "extra": []},
            {"type": "series", "id": "adkami_genre_tranche_de_vie", "name": "☀️ Tranche de vie", "extra": []},
            {"type": "series", "id": "adkami_genre_triangle_amoureux", "name": "💔 Triangle Amoureux", "extra": []},
            {"type": "series", "id": "adkami_genre_yaoi", "name": "👬 Yaoi", "extra": []},
            {"type": "series", "id": "adkami_genre_yuri", "name": "👭 Yuri", "extra": []},
        ],
        "resources": [
            "catalog",
            {
